...
export const Mint = (props) => {
  ...
  async function onMint() {
    ...
    console.log("linked_wallet", linked_wallet.address, imx_client);
    ...
    console.log("imx_balance_eth", imx_balance_eth)
    if (chainId == '0x3') {
    ...
    console.log("eth_balance_eth", eth_balance_eth)
    ...
    console.log("alchemy_provider", alchemy_provider)
